...
const {actions, reducer} = dronesHistorySlice;

const dronesHistoryActions = {
    ...actions,
}

const dronesHistoryReducer = persistReducer(persistConfig, reducer);

export {
    dronesHistoryActions,
    dronesHistoryReducer,
}
// export const dronesHistoryActions = dronesHistorySlice.actions;
// export const dronesHistoryReducer = persistReducer(persistConfig, dronesHistorySlice.reducer);
